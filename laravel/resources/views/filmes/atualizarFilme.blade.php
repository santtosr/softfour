        ...
        <x-auth-card>
            ...
            <form method="POST" action="{{Request::url()}}/salvar" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <x-input id="id" class="block mt-1 w-full" value="{{$filme->id}}" type="text" name="id" required readonly/>
                </div>
                ...
                <div>
                    ...
                    <x-input id="titulo" class="block mt-1 w-full" value="{{$filme->titulo}}" type="text" name="titulo" required autofocus />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <x-input id="ano_lancamento" class="block mt-1 w-full" value="{{$filme->ano_lancamento}}" type="text" name="ano_lancamento" required />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <x-input id="diretor" class="block mt-1 w-full" value="{{$filme->diretor}}" type="text" name="diretor" required />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <textarea id="sinopse" class="block mt-1 w-full border-2" rows="10" type="text" name="sinopse" required>{{$filme->sinopse}}</textarea> 
                </div>
                ...
                <!-- Imagem Atual -->
                <div class="mt-4">
                    <x-input id="imagem_atual" class="block mt-1 w-full" value="{{$filme->imagem}}" type="hidden" name="imagem_atual" required/>
                </div>
